  ...
  return (
    <Styled.Wrapper>
      <Styled.StaticContentWrapper>
        <h1>Welcome</h1>
        <p>
          My name is Marcos Hirazawa, I'm 23 years old and I'm a full stack
          developer based in Londrina, Paraná, Brazil. I've been studying
          programming for 2 years and I've gathered around 500 hours between
          studying and projects. My main skills are React.js, Node.js and
          TypeScript, but I'm always trying to broaden my knowledge. I have a
          degree in civil engineering but my interest lies at the technology
          area, therefore I'm getting another degree in data science and
          artificial intelligence with plans to graduate by 2026. I'm mainly
          interested at the web and app development, but my goal is to get into
          the tech area so I can learn even more.
        </p>
      </Styled.StaticContentWrapper>
